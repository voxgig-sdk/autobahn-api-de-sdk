...
describe('exists', async () => {
  ...
  //
  // AutobahnApiDeSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof AutobahnApiDeSDK, true,
      'AutobahnApiDeSDK.test() must return a client synchronously')
  })
