...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.AUTOBAHNAPIDE_TEST_LIVE ||
    'TRUE' === process.env.AUTOBAHNAPIDE_TEST_OVERRIDE
  ) {
  ...
  m.AUTOBAHNAPIDE_TEST_EXPLAIN = process.env.AUTOBAHNAPIDE_TEST_EXPLAIN || m.AUTOBAHNAPIDE_TEST_EXPLAIN
