...
function envOverride(m) {
    if ('TRUE' === process.env.AUTOBAHN_API_DE_TEST_LIVE ||
        'TRUE' === process.env.AUTOBAHN_API_DE_TEST_OVERRIDE) {
    ...
    m.AUTOBAHN_API_DE_TEST_EXPLAIN = process.env.AUTOBAHN_API_DE_TEST_EXPLAIN || m.AUTOBAHN_API_DE_TEST_EXPLAIN;
    return m;
}
