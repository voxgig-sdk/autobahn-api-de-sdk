...
(0, node_test_1.describe)('ElectricChargingStationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-electric_charging_station', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-electric_charging_station', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-electric_charging_station', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-electric_charging_station', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOBAHN_API_DE_TEST_ELECTRIC_CHARGING_STATION_ENTID'];
...
//# sourceMappingURL=ElectricChargingStationDirect.test.js.map