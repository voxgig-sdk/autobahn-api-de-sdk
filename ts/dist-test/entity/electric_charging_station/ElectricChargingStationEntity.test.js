...
(0, node_test_1.describe)('ElectricChargingStationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(electric_charging_station_ref01_data_dt0.id === electric_charging_station_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/electric_charging_station/ElectricChargingStationTestData.json');
    ...
    let idmap = transform(['electric_charging_station01', 'electric_charging_station02', 'electric_charging_station03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'AUTOBAHN_API_DE_TEST_ELECTRIC_CHARGING_STATION_ENTID': idmap,
        'AUTOBAHN_API_DE_TEST_LIVE': 'FALSE',
        'AUTOBAHN_API_DE_TEST_EXPLAIN': 'FALSE',
    });
    idmap = env['AUTOBAHN_API_DE_TEST_ELECTRIC_CHARGING_STATION_ENTID'];
    const live = 'TRUE' === env.AUTOBAHN_API_DE_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['AUTOBAHN_API_DE_TEST_ELECTRIC_CHARGING_STATION_ENTID'];
...
//# sourceMappingURL=ElectricChargingStationEntity.test.js.map