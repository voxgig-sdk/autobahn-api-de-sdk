...
(0, node_test_1.describe)('ClosureEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(closure_ref01_data_dt0.id === closure_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/closure/ClosureTestData.json');
    ...
    let idmap = transform(['closure01', 'closure02', 'closure03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['AUTOBAHN_API_DE_TEST_CLOSURE_ENTID'];
    const live = 'TRUE' === env.AUTOBAHN_API_DE_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['AUTOBAHN_API_DE_TEST_CLOSURE_ENTID'];
...
//# sourceMappingURL=ClosureEntity.test.js.map