...
(0, node_test_1.describe)('ClosureDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-closure', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-closure', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-closure', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-closure', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'AUTOBAHN_API_DE_TEST_CLOSURE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['AUTOBAHN_API_DE_TEST_CLOSURE_ENTID'];
...
//# sourceMappingURL=ClosureDirect.test.js.map