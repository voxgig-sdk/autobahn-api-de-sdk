...
(0, node_test_1.describe)('ParkingLorryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'parking_lorry.' + op, live))
                return;
        }
        ...
        let parking_lorry_ref01_data = Object.values(setup.data.existing.parking_lorry)[0];
        // LIST
        const parking_lorry_ref01_ent = client.ParkingLorry();
        const parking_lorry_ref01_match = {};
        parking_lorry_ref01_match['road_id'] = setup.idmap['road01'];
        const parking_lorry_ref01_list = (await parking_lorry_ref01_ent.list(parking_lorry_ref01_match)).map((e) => e.data());
        // LOAD
        const parking_lorry_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(parking_lorry_ref01_data_dt0.id === parking_lorry_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/parking_lorry/ParkingLorryTestData.json');
    ...
    let idmap = transform(['parking_lorry01', 'parking_lorry02', 'parking_lorry03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ParkingLorryEntity.test.js.map