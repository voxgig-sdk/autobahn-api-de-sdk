...
(0, node_test_1.describe)('ParkingLorryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AutobahnApiDeSDK({
    ...
    (0, node_test_1.test)('direct-load-parking_lorry', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-parking_lorry', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-parking_lorry', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-parking_lorry', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["road01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.AUTOBAHN_API_DE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AutobahnApiDeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['AUTOBAHN_API_DE_TEST_PARKING_LORRY_ENTID'];
    ...
    const client = new __1.AutobahnApiDeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ParkingLorryDirect.test.js.map