...
(0, node_test_1.describe)('WebcamDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-webcam', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-webcam', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-webcam', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-webcam', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOBAHN_API_DE_TEST_WEBCAM_ENTID'];
...
//# sourceMappingURL=WebcamDirect.test.js.map