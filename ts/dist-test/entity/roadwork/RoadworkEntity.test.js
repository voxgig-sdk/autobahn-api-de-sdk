...
(0, node_test_1.describe)('RoadworkEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(roadwork_ref01_data_dt0.id === roadwork_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/roadwork/RoadworkTestData.json');
    ...
    let idmap = transform(['roadwork01', 'roadwork02', 'roadwork03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['AUTOBAHN_API_DE_TEST_ROADWORK_ENTID'];
    const live = 'TRUE' === env.AUTOBAHN_API_DE_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['AUTOBAHN_API_DE_TEST_ROADWORK_ENTID'];
...
//# sourceMappingURL=RoadworkEntity.test.js.map