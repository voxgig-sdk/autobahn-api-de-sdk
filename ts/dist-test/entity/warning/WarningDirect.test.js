...
(0, node_test_1.describe)('WarningDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-warning', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-warning', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-warning', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-warning', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOBAHN_API_DE_TEST_WARNING_ENTID'];
...
//# sourceMappingURL=WarningDirect.test.js.map