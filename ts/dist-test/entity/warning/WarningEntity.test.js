...
(0, node_test_1.describe)('WarningEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'warning.' + op, live))
                return;
        }
        ...
        let warning_ref01_data = Object.values(setup.data.existing.warning)[0];
        // LIST
        const warning_ref01_ent = client.Warning();
        const warning_ref01_match = {};
        warning_ref01_match['road_id'] = setup.idmap['road01'];
        const warning_ref01_list = (await warning_ref01_ent.list(warning_ref01_match)).map((e) => e.data());
        // LOAD
        const warning_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(warning_ref01_data_dt0.id === warning_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/warning/WarningTestData.json');
    ...
    let idmap = transform(['warning01', 'warning02', 'warning03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=WarningEntity.test.js.map