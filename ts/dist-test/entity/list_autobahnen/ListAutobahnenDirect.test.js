...
(0, node_test_1.describe)('ListAutobahnenDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-list_autobahnen', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-list_autobahnen', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOBAHN_API_DE_TEST_LIST_AUTOBAHNEN_ENTID'];
...
//# sourceMappingURL=ListAutobahnenDirect.test.js.map