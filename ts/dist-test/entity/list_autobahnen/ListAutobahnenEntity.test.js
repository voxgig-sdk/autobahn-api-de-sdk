...
(0, node_test_1.describe)('ListAutobahnenEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/list_autobahnen/ListAutobahnenTestData.json');
    ...
    let idmap = transform(['list_autobahnen01', 'list_autobahnen02', 'list_autobahnen03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ListAutobahnenEntity.test.js.map