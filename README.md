...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/autobahn-api-de` | `npm install @voxgig-sdk/autobahn-api-de` |
| Python | `voxgig-sdk-autobahn-api-de` | `pip install voxgig-sdk-autobahn-api-de` |
| PHP | `voxgig-sdk/autobahn-api-de` | `composer require voxgig-sdk/autobahn-api-de` |
| Golang | `github.com/voxgig-sdk/autobahn-api-de-sdk/go` | `go get github.com/voxgig-sdk/autobahn-api-de-sdk/go` |
| Ruby | `voxgig-sdk-autobahn-api-de` | `gem install voxgig-sdk-autobahn-api-de` |
| Lua | `voxgig-sdk-autobahn-api-de` | `luarocks install voxgig-sdk-autobahn-api-de` |
