...
This SDK exposes the API as a small set of **semantic entities** — Closure, ElectricChargingStation, ListAutobahnen, ParkingLorry, Roadwork, Warning and Webcam — that you
