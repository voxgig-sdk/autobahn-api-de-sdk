...
The Golang SDK for the AutobahnApiDe API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/autobahn-api-de-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/autobahn-api-de-sdk=../path/to/github.com/voxgig-sdk/autobahn-api-de-sdk
```
...
```
github.com/voxgig-sdk/autobahn-api-de-sdk/
...
The root package (`github.com/voxgig-sdk/autobahn-api-de-sdk`) re-exports everything needed
