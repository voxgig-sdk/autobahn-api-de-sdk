...
const testSeed = `map[string]any{"entity": map[string]any{"closure": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "electric_charging_station": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list_autobahnen": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "parking_lorry": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "roadwork": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "warning": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webcam": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
