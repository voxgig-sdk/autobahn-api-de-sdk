...
func TestClosureEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set AUTOBAHNAPIDE_TEST_CLOSURE_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func closureBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("AUTOBAHNAPIDE_TEST_CLOSURE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["AUTOBAHNAPIDE_TEST_CLOSURE_ENTID"])
