...
// instead of `sdk.NewAutobahnApiDeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AutobahnApiDeSDK  { return NewAutobahnApiDeSDK(nil) }
func Test() *AutobahnApiDeSDK { return TestSDK(nil, nil) }
