...
func NewWarningEntity(client *core.AutobahnApiDeSDK, entopts map[string]any) *WarningEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WarningEntity) GetName() string { return e.name }
...
func (e *WarningEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WarningEntity) Deleted() bool {
	return e.deleted
}


func (e *WarningEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWarningEntity(e.client, opts)
}

func (e *WarningEntity) Data(args ...any) any {
...
func (e *WarningEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Warning; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WarningEntity) DataTyped(data ...Warning) Warning {
	if len(data) > 0 {
		return typedFrom[Warning](e.Data(asMap(data[0])))
	}
	return typedFrom[Warning](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Warning (all fields
// optional at the wire level).
func (e *WarningEntity) MatchTyped(match ...Warning) Warning {
	if len(match) > 0 {
		return typedFrom[Warning](e.Match(asMap(match[0])))
	}
	return typedFrom[Warning](e.Match())
}
...
func (e *WarningEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WarningEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WarningLoadMatch and returns an Warning. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WarningEntity) LoadTyped(reqmatch WarningLoadMatch, ctrl map[string]any) (Warning, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Warning{}, err
	}
	return typedFrom[Warning](res), nil
}




func (e *WarningEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// WarningListMatch and returns []Warning. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WarningEntity) ListTyped(reqmatch WarningListMatch, ctrl map[string]any) ([]Warning, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Warning](res), nil
}



func (e *WarningEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WarningEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WarningEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WarningEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
