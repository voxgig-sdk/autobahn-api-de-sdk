...
func NewWebcamEntity(client *core.AutobahnApiDeSDK, entopts map[string]any) *WebcamEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WebcamEntity) GetName() string { return e.name }
...
func (e *WebcamEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WebcamEntity) Deleted() bool {
	return e.deleted
}


func (e *WebcamEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWebcamEntity(e.client, opts)
}

func (e *WebcamEntity) Data(args ...any) any {
...
func (e *WebcamEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Webcam; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WebcamEntity) DataTyped(data ...Webcam) Webcam {
	if len(data) > 0 {
		return typedFrom[Webcam](e.Data(asMap(data[0])))
	}
	return typedFrom[Webcam](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Webcam (all fields
// optional at the wire level).
func (e *WebcamEntity) MatchTyped(match ...Webcam) Webcam {
	if len(match) > 0 {
		return typedFrom[Webcam](e.Match(asMap(match[0])))
	}
	return typedFrom[Webcam](e.Match())
}
...
func (e *WebcamEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WebcamEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WebcamLoadMatch and returns an Webcam. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WebcamEntity) LoadTyped(reqmatch WebcamLoadMatch, ctrl map[string]any) (Webcam, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Webcam{}, err
	}
	return typedFrom[Webcam](res), nil
}




func (e *WebcamEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// WebcamListMatch and returns []Webcam. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WebcamEntity) ListTyped(reqmatch WebcamListMatch, ctrl map[string]any) ([]Webcam, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Webcam](res), nil
}



func (e *WebcamEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WebcamEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WebcamEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WebcamEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
