...
func NewRoadworkEntity(client *core.AutobahnApiDeSDK, entopts map[string]any) *RoadworkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RoadworkEntity) GetName() string { return e.name }
...
func (e *RoadworkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RoadworkEntity) Deleted() bool {
	return e.deleted
}


func (e *RoadworkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRoadworkEntity(e.client, opts)
}

func (e *RoadworkEntity) Data(args ...any) any {
...
func (e *RoadworkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Roadwork; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RoadworkEntity) DataTyped(data ...Roadwork) Roadwork {
	if len(data) > 0 {
		return typedFrom[Roadwork](e.Data(asMap(data[0])))
	}
	return typedFrom[Roadwork](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Roadwork (all fields
// optional at the wire level).
func (e *RoadworkEntity) MatchTyped(match ...Roadwork) Roadwork {
	if len(match) > 0 {
		return typedFrom[Roadwork](e.Match(asMap(match[0])))
	}
	return typedFrom[Roadwork](e.Match())
}
...
func (e *RoadworkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RoadworkEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RoadworkLoadMatch and returns an Roadwork. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RoadworkEntity) LoadTyped(reqmatch RoadworkLoadMatch, ctrl map[string]any) (Roadwork, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Roadwork{}, err
	}
	return typedFrom[Roadwork](res), nil
}




func (e *RoadworkEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RoadworkListMatch and returns []Roadwork. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RoadworkEntity) ListTyped(reqmatch RoadworkListMatch, ctrl map[string]any) ([]Roadwork, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Roadwork](res), nil
}



func (e *RoadworkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RoadworkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RoadworkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RoadworkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
