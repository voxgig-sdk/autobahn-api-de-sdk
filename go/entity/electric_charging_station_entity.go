...
func NewElectricChargingStationEntity(client *core.AutobahnApiDeSDK, entopts map[string]any) *ElectricChargingStationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &ElectricChargingStationEntity{
...
func (e *ElectricChargingStationEntity) GetName() string { return e.name }
...
func (e *ElectricChargingStationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ElectricChargingStationEntity) Deleted() bool {
	return e.deleted
}


func (e *ElectricChargingStationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewElectricChargingStationEntity(e.client, opts)
}

func (e *ElectricChargingStationEntity) Data(args ...any) any {
...
func (e *ElectricChargingStationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ElectricChargingStationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ElectricChargingStationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *ElectricChargingStationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ElectricChargingStationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ElectricChargingStationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ElectricChargingStationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
