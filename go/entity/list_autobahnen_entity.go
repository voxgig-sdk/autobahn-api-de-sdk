...
type ListAutobahnenEntity struct {
	name    string
...
func NewListAutobahnenEntity(client *core.AutobahnApiDeSDK, entopts map[string]any) *ListAutobahnenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListAutobahnenEntity) GetName() string { return e.name }
...
func (e *ListAutobahnenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListAutobahnenEntity) Deleted() bool {
	return e.deleted
}


func (e *ListAutobahnenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListAutobahnenEntity(e.client, opts)
}

func (e *ListAutobahnenEntity) Data(args ...any) any {
...
func (e *ListAutobahnenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ListAutobahnen; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ListAutobahnenEntity) DataTyped(data ...ListAutobahnen) ListAutobahnen {
	if len(data) > 0 {
		return typedFrom[ListAutobahnen](e.Data(asMap(data[0])))
	}
	return typedFrom[ListAutobahnen](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ListAutobahnen (all fields
// optional at the wire level).
func (e *ListAutobahnenEntity) MatchTyped(match ...ListAutobahnen) ListAutobahnen {
	if len(match) > 0 {
		return typedFrom[ListAutobahnen](e.Match(asMap(match[0])))
	}
	return typedFrom[ListAutobahnen](e.Match())
}
...
func (e *ListAutobahnenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListAutobahnenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ListAutobahnenEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ListAutobahnenListMatch and returns []ListAutobahnen. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ListAutobahnenEntity) ListTyped(reqmatch ListAutobahnenListMatch, ctrl map[string]any) ([]ListAutobahnen, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ListAutobahnen](res), nil
}



func (e *ListAutobahnenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ListAutobahnenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListAutobahnenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListAutobahnenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
