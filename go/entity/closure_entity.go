...
func NewClosureEntity(client *core.AutobahnApiDeSDK, entopts map[string]any) *ClosureEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClosureEntity) GetName() string { return e.name }
...
func (e *ClosureEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClosureEntity) Deleted() bool {
	return e.deleted
}


func (e *ClosureEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClosureEntity(e.client, opts)
}

func (e *ClosureEntity) Data(args ...any) any {
...
func (e *ClosureEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ClosureEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClosureEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *ClosureEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClosureEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClosureEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClosureEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
