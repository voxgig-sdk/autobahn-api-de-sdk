...
func (sdk *AutobahnApiDeSDK) OptionsMap() map[string]any {
...
func (sdk *AutobahnApiDeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AutobahnApiDeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AutobahnApiDeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AutobahnApiDeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AutobahnApiDeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AutobahnApiDeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AutobahnApiDeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AutobahnApiDeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AutobahnApiDeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AutobahnApiDeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AutobahnApiDeSDK {
	...
	sdk := NewAutobahnApiDeSDK(sdkopts)
	sdk.Mode = "test"
