...
// AutobahnApiDe SDK metrics feature
...
class AutobahnApiDeMetricsFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _record(AutobahnApiDeContext $ctx, bool $ok): void
    {
