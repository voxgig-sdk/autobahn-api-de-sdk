...
// AutobahnApiDe SDK idempotency feature
...
class AutobahnApiDeIdempotencyFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _mutating(AutobahnApiDeContext $ctx): bool
    {
