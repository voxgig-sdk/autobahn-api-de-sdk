...
// AutobahnApiDe SDK timeout feature
...
class AutobahnApiDeTimeoutFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _with_timeout(AutobahnApiDeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AutobahnApiDeContext $_ctx, float $ms): void
    {
        $client = $this->client;
