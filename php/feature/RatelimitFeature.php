...
// AutobahnApiDe SDK ratelimit feature
...
class AutobahnApiDeRatelimitFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _acquire(AutobahnApiDeContext $ctx): void
    {
    ...
    private function _track(AutobahnApiDeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
