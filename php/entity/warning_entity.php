...
// AutobahnApiDe SDK Warning entity
...
class WarningEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WarningEntity($this->_client, $opts);
    }

    /**
     * @param Warning|array $args Warning data (assoc-array) to store.
     */
    ...
    /**
     * @return Warning|array The current Warning data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Warning fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Warning fields).
     */
     ...
     *
     * @param WarningLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WarningLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Warning|array The loaded Warning as an assoc-array at the
     ...
     *
     * @param WarningListMatch|array|null $reqmatch Match filter (any subset
     *   of Warning fields) as an assoc-array; WarningListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Warning[]|array A list of Warning items as assoc-arrays at
