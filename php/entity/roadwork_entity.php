...
class RoadworkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RoadworkEntity($this->_client, $opts);
    }

    /**
     * @param Roadwork|array $args Roadwork data (assoc-array) to store.
     */
    ...
    /**
     * @return Roadwork|array The current Roadwork data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Roadwork fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Roadwork fields).
     */
    ...
    /**
     * Load a single Roadwork.
     *
     * @param RoadworkLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RoadworkLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Roadwork|array The loaded Roadwork as an assoc-array at the
    ...
    /**
     * List Roadwork items matching the given filter.
     *
     * @param RoadworkListMatch|array|null $reqmatch Match filter (any subset
     *   of Roadwork fields) as an assoc-array; RoadworkListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Roadwork[]|array A list of Roadwork items as assoc-arrays at
