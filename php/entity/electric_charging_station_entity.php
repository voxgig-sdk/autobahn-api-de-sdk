...
// AutobahnApiDe SDK ElectricChargingStation entity
...
class ElectricChargingStationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "electric_charging_station";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ElectricChargingStationEntity($this->_client, $opts);
    }

    /**
     * @param ElectricChargingStation|array $args ElectricChargingStation data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = AutobahnApiDeHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return ElectricChargingStation|array The current ElectricChargingStation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ElectricChargingStation fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = AutobahnApiDeHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of ElectricChargingStation fields).
     */
    ...
    /**
     * Load a single ElectricChargingStation.
     *
     * @param ElectricChargingStationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ElectricChargingStationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ElectricChargingStation|array The loaded ElectricChargingStation as an assoc-array at the
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = AutobahnApiDeHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * List ElectricChargingStation items matching the given filter.
     *
     * @param ElectricChargingStationListMatch|array|null $reqmatch Match filter (any subset
     *   of ElectricChargingStation fields) as an assoc-array; ElectricChargingStationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ElectricChargingStation[]|array A list of ElectricChargingStation items as assoc-arrays at
