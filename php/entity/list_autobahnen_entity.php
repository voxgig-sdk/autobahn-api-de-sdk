...
// AutobahnApiDe SDK ListAutobahnen entity
...
class ListAutobahnenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ListAutobahnenEntity($this->_client, $opts);
    }

    /**
     * @param ListAutobahnen|array $args ListAutobahnen data (assoc-array) to store.
     */
    ...
    /**
     * @return ListAutobahnen|array The current ListAutobahnen data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListAutobahnen fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListAutobahnen fields).
     */
    ...
    /**
     * List ListAutobahnen items matching the given filter.
     *
     * @param ListAutobahnenListMatch|array|null $reqmatch Match filter (any subset
     *   of ListAutobahnen fields) as an assoc-array; ListAutobahnenListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListAutobahnen[]|array A list of ListAutobahnen items as assoc-arrays at
