...
// AutobahnApiDe SDK Closure entity
...
class ClosureEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ClosureEntity($this->_client, $opts);
    }

    /**
     * @param Closure|array $args Closure data (assoc-array) to store.
     */
    ...
    /**
     * @return Closure|array The current Closure data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Closure fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Closure fields).
     */
     ...
     *
     * @param ClosureLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ClosureLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Closure|array The loaded Closure as an assoc-array at the
     ...
     *
     * @param ClosureListMatch|array|null $reqmatch Match filter (any subset
     *   of Closure fields) as an assoc-array; ClosureListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Closure[]|array A list of Closure items as assoc-arrays at
