...
// AutobahnApiDe SDK utility: graphql
//
...
class AutobahnApiDeGraphql
{
    ...
    // equivalent.
    public static function body(AutobahnApiDeContext $ctx): mixed
    {
    ...
    public static function errors(AutobahnApiDeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
