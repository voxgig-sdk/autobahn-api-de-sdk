...
// AutobahnApiDe SDK utility: make_options

class AutobahnApiDeMakeOptions
{
    ...
    public static function call(AutobahnApiDeContext $ctx): array
    {
        ...
        //
        // `AutobahnApiDeSchema::optspec()` is built from the model:
        ...
        $optspec = AutobahnApiDeSchema::optspec();
