...
// AutobahnApiDe SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AutobahnApiDeSDK::test)
...
{
    private const SDK_CLASS = 'AutobahnApiDeSDK';
    ...
    private const SDK_BASE = 'autobahnapide_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../autobahnapide_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
