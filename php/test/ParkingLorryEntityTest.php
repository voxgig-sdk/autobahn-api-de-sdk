...
class ParkingLorryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set AUTOBAHNAPIDE_TEST_PARKING_LORRY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function parking_lorry_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("AUTOBAHNAPIDE_TEST_PARKING_LORRY_ENTID");
