...
class AutobahnApiDeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AutobahnApiDeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AutobahnApiDeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AutobahnApiDeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
