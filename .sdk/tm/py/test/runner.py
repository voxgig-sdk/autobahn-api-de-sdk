...
class AutobahnApiDeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AutobahnApiDeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AutobahnApiDeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AutobahnApiDeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
