...
// AutobahnApiDe SDK utility type

class AutobahnApiDeUtility
{
    ...
    public static function copy(AutobahnApiDeUtility $src): AutobahnApiDeUtility
    {
        $u = new AutobahnApiDeUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
