...
// AutobahnApiDe SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AutobahnApiDeMakeRequest
{
    public static function call(AutobahnApiDeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AutobahnApiDeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AutobahnApiDeResponse($fetched);
        } else {
