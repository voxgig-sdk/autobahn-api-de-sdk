...
// AutobahnApiDe SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AutobahnApiDeTransformResponse
{
    public static function call(AutobahnApiDeContext $ctx): mixed
    {
        ...
        $transform = AutobahnApiDeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
