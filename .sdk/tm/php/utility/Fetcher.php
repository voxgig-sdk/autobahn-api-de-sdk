...
// AutobahnApiDe SDK utility: fetcher

class AutobahnApiDeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AutobahnApiDeSDK/1.0)';
    ...
    public static function call(AutobahnApiDeContext $ctx, string $fullurl, array $fetchdef): array
    {
