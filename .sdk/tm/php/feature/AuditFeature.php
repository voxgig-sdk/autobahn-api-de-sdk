...
// AutobahnApiDe SDK audit feature
...
class AutobahnApiDeAuditFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _emit(AutobahnApiDeContext $ctx, string $outcome): void
    {
