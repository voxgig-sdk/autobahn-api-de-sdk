...
// AutobahnApiDe SDK clienttrack feature
...
class AutobahnApiDeClienttrackFeature extends AutobahnApiDeBaseFeature
{
    ...
    public function PostConstruct(AutobahnApiDeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AutobahnApiDe-SDK';
