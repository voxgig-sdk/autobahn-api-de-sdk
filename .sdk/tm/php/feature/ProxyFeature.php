...
// AutobahnApiDe SDK proxy feature
...
class AutobahnApiDeProxyFeature extends AutobahnApiDeBaseFeature
{
    ...
    public function init(AutobahnApiDeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AutobahnApiDeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
