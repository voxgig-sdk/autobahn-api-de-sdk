...
// AutobahnApiDe SDK rbac feature
...
class AutobahnApiDeRbacFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _required(AutobahnApiDeContext $ctx): ?string
    {
    ...
    private function _reject(AutobahnApiDeContext $ctx, string $required): void
    {
    ...
    private function _track(AutobahnApiDeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
