...
// AutobahnApiDe SDK telemetry feature
...
class AutobahnApiDeTelemetryFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _close(AutobahnApiDeContext $ctx, bool $ok): void
    {
