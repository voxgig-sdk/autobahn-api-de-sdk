...
// AutobahnApiDe SDK streaming feature
...
class AutobahnApiDeStreamingFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _iterate(AutobahnApiDeResult $result): \Generator
    {
    ...
    private function _streamable(AutobahnApiDeContext $ctx): bool
    {
