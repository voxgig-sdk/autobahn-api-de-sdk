...
// AutobahnApiDe SDK cache feature
...
class AutobahnApiDeCacheFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _through(AutobahnApiDeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
