...
// AutobahnApiDe SDK netsim feature
...
class AutobahnApiDeNetsimFeature extends AutobahnApiDeBaseFeature
{
    ...
    private function _simulate(AutobahnApiDeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AutobahnApiDeContext $ctx, array $applied): void
    {
        $client = $this->client;
