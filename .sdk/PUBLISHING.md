...
|---|---|---|
| `ts/` | @voxgig-sdk/autobahn-api-de-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/autobahn-api-de-sdk \
      --repository voxgig-sdk/autobahn-api-de-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/autobahn-api-de-sdk` shows it, and
`npm trust revoke @voxgig-sdk/autobahn-api-de-sdk --id=<id>` removes it.
