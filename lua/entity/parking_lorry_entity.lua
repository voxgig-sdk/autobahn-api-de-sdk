...
local ParkingLorryEntity = {}
ParkingLorryEntity.__index = ParkingLorryEntity


function ParkingLorryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ParkingLorryEntity)
  self._name = "parking_lorry"
  self._client = client
...
function ParkingLorryEntity:get_name()
  return self._name
end


function ParkingLorryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ParkingLorryEntity.new(self._client, opts)
end
...
function ParkingLorryEntity:mark_deleted()
  self._deleted = true
end


function ParkingLorryEntity:deleted()
  return true == self._deleted
end


function ParkingLorryEntity:data_set(args)
  if args ~= nil then
...
function ParkingLorryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ParkingLorryEntity:match_set(args)
  if args ~= nil then
...
function ParkingLorryEntity:match_get()
...
function ParkingLorryEntity:stream(action, args, callopts)
...
function ParkingLorryEntity:_run_op(ctx, post_done)
  local utility = self._utility
