...
local ElectricChargingStationEntity = {}
ElectricChargingStationEntity.__index = ElectricChargingStationEntity


function ElectricChargingStationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ElectricChargingStationEntity)
  self._name = "electric_charging_station"
  self._client = client
...
function ElectricChargingStationEntity:get_name()
  return self._name
end


function ElectricChargingStationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ElectricChargingStationEntity.new(self._client, opts)
end
...
function ElectricChargingStationEntity:mark_deleted()
  self._deleted = true
end


function ElectricChargingStationEntity:deleted()
  return true == self._deleted
end


function ElectricChargingStationEntity:data_set(args)
  if args ~= nil then
...
function ElectricChargingStationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ElectricChargingStationEntity:match_set(args)
  if args ~= nil then
...
function ElectricChargingStationEntity:match_get()
...
function ElectricChargingStationEntity:stream(action, args, callopts)
...
function ElectricChargingStationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ElectricChargingStationEntity
