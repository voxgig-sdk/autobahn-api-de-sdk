...
local WarningEntity = {}
WarningEntity.__index = WarningEntity


function WarningEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WarningEntity)
  self._name = "warning"
  self._client = client
...
function WarningEntity:get_name()
  return self._name
end


function WarningEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WarningEntity.new(self._client, opts)
end
...
function WarningEntity:mark_deleted()
  self._deleted = true
end


function WarningEntity:deleted()
  return true == self._deleted
end


function WarningEntity:data_set(args)
  if args ~= nil then
...
function WarningEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WarningEntity:match_set(args)
  if args ~= nil then
...
function WarningEntity:match_get()
...
function WarningEntity:stream(action, args, callopts)
...
---@param reqmatch WarningLoadMatch
---@param ctrl? table
---@return Warning
---@return string? err
function WarningEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch WarningListMatch
---@param ctrl? table
---@return Warning[]
---@return string? err
function WarningEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function WarningEntity:_run_op(ctx, post_done)
  local utility = self._utility
