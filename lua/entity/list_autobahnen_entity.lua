...
local ListAutobahnenEntity = {}
ListAutobahnenEntity.__index = ListAutobahnenEntity


function ListAutobahnenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListAutobahnenEntity)
  self._name = "list_autobahnen"
  self._client = client
...
function ListAutobahnenEntity:get_name()
  return self._name
end


function ListAutobahnenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ListAutobahnenEntity.new(self._client, opts)
end
...
function ListAutobahnenEntity:mark_deleted()
  self._deleted = true
end


function ListAutobahnenEntity:deleted()
  return true == self._deleted
end


function ListAutobahnenEntity:data_set(args)
  if args ~= nil then
...
function ListAutobahnenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListAutobahnenEntity:match_set(args)
  if args ~= nil then
...
function ListAutobahnenEntity:match_get()
...
function ListAutobahnenEntity:stream(action, args, callopts)
...
function ListAutobahnenEntity:_run_op(ctx, post_done)
  local utility = self._utility
