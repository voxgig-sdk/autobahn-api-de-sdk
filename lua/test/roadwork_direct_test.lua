...
describe("RoadworkDirect", function()
  it("should direct-list-roadwork", function()
    local setup = roadwork_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-roadwork", setup.live and "live" or "unit")
  ...
  it("should direct-load-roadwork", function()
    local setup = roadwork_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-roadwork", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function roadwork_direct_setup(mockres)
