...
describe("ListAutobahnenDirect", function()
  it("should direct-list-list_autobahnen", function()
    local setup = list_autobahnen_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-list_autobahnen", setup.live and "live" or "unit")
...
function list_autobahnen_direct_setup(mockres)
