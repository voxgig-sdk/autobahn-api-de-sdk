...
describe("RoadworkEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Roadwork(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Roadwork(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set AUTOBAHN_API_DE_TEST_ROADWORK_ENTID JSON to run live")
      return
    end
...
function roadwork_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("AUTOBAHN_API_DE_TEST_ROADWORK_ENTID")
