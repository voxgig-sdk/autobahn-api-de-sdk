...
describe("ClosureDirect", function()
  it("should direct-list-closure", function()
    local setup = closure_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-closure", setup.live and "live" or "unit")
  ...
  it("should direct-load-closure", function()
    local setup = closure_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-closure", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function closure_direct_setup(mockres)
