...
function runner.env_override(m)
  local live = runner.getenv("AUTOBAHNAPIDE_TEST_LIVE")
  local override = runner.getenv("AUTOBAHNAPIDE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AUTOBAHNAPIDE_TEST_EXPLAIN")
