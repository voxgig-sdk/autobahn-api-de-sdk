...
local SDK_MODULE = "autobahn-api-de_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["closure"] = { ["test01"] = { id = "test01" } }, ["electric_charging_station"] = { ["test01"] = { id = "test01" } }, ["list_autobahnen"] = { ["test01"] = { id = "test01" } }, ["parking_lorry"] = { ["test01"] = { id = "test01" } }, ["roadwork"] = { ["test01"] = { id = "test01" } }, ["warning"] = { ["test01"] = { id = "test01" } }, ["webcam"] = { ["test01"] = { id = "test01" } } } }'
