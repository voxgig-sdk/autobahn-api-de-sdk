...
local AutobahnApiDeSDK = {}
AutobahnApiDeSDK.__index = AutobahnApiDeSDK
...
AutobahnApiDeSDK._make_feature = _make_feature


function AutobahnApiDeSDK.new(options)
  local self = setmetatable({}, AutobahnApiDeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AutobahnApiDeSDK:options_map()
...
function AutobahnApiDeSDK:get_utility()
  return Utility.copy(self._utility)
end


function AutobahnApiDeSDK:get_root_ctx()
  return self._rootctx
end


function AutobahnApiDeSDK:prepare(fetchargs)
...
function AutobahnApiDeSDK:direct(fetchargs)
...
-- by passing it.
function AutobahnApiDeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function AutobahnApiDeSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "AutobahnApiDeSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function AutobahnApiDeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = AutobahnApiDeSDK.new(sdkopts)
  sdk.mode = "test"
