...
class AutobahnApiDeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AutobahnApiDeTestRunner.getenv("AUTOBAHNAPIDE_TEST_LIVE")
        override = AutobahnApiDeTestRunner.getenv("AUTOBAHNAPIDE_TEST_OVERRIDE")
        ...
        explain = AutobahnApiDeTestRunner.getenv("AUTOBAHNAPIDE_TEST_EXPLAIN")
