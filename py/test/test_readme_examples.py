# AutobahnApiDe SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AutobahnApiDeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AutobahnApiDeSDK(...) and AutobahnApiDeSDK.test(...) become
#      AutobahnApiDeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "autobahnapide_sdk"
_SDK_CLASS = "AutobahnApiDeSDK"
...
_ENTITIES = {
    ...
    "ListAutobahnen": "list_autobahnen",
    "ParkingLorry": "parking_lorry",
    "Roadwork": "roadwork",
    "Warning": "warning",
    "Webcam": "webcam",
}
