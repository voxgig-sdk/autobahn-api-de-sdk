...
from autobahnapide_sdk.utility import register

# Load features
from autobahnapide_sdk.feature.base_feature import AutobahnApiDeBaseFeature
from autobahnapide_sdk.features import _has_feature, _make_feature
...
class AutobahnApiDeSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "AutobahnApiDeSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AutobahnApiDeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Closure(self, data=None) -> "ClosureEntity":
        ...
        from autobahnapide_sdk.entity.closure_entity import ClosureEntity
    ...
    def ElectricChargingStation(self, data=None) -> "ElectricChargingStationEntity":
        ...
        from autobahnapide_sdk.entity.electric_charging_station_entity import ElectricChargingStationEntity
    ...
    def ListAutobahnen(self, data=None) -> "ListAutobahnenEntity":
        ...
        from autobahnapide_sdk.entity.list_autobahnen_entity import ListAutobahnenEntity
    ...
    def ParkingLorry(self, data=None) -> "ParkingLorryEntity":
        ...
        from autobahnapide_sdk.entity.parking_lorry_entity import ParkingLorryEntity
    ...
    def Roadwork(self, data=None) -> "RoadworkEntity":
        ...
        from autobahnapide_sdk.entity.roadwork_entity import RoadworkEntity
    ...
    def Warning(self, data=None) -> "WarningEntity":
        ...
        from autobahnapide_sdk.entity.warning_entity import WarningEntity
    ...
    def Webcam(self, data=None) -> "WebcamEntity":
        ...
        from autobahnapide_sdk.entity.webcam_entity import WebcamEntity
