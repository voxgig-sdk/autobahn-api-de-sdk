...
class ListAutobahnenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ListAutobahnenEntity(self._client, opts)
    ...
    def data_get(self) -> ListAutobahnen:
    ...
    def match_get(self) -> ListAutobahnen:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ListAutobahnen]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ListAutobahnen().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
