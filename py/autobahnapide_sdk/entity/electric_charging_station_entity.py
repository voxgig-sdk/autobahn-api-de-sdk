...
from autobahnapide_sdk.autobahnapide_types import (
...
class ElectricChargingStationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ElectricChargingStationEntity(self._client, opts)
    ...
    def data_get(self) -> ElectricChargingStation:
    ...
    def match_get(self) -> ElectricChargingStation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ElectricChargingStation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ElectricChargingStation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ElectricChargingStation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ElectricChargingStation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
