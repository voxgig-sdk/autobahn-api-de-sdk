...
func registerSDKWords(r *eng.Registry, client *sdk.AutobahnApiDeSDK) {
...
func runOp(client *sdk.AutobahnApiDeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
