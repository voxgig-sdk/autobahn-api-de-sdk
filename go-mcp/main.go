// Command AutobahnApiDe-mcp is an MCP server exposing the AutobahnApiDe
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AutobahnApiDe_list  — list records of an entity
//	AutobahnApiDe_load  — load a single record of an entity
//
