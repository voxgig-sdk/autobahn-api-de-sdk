...
#      offline in seeded test mode (AutobahnApiDeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AutobahnApiDe_sdk.rb")
  SDK_CLASS = "AutobahnApiDeSDK"
