...
class RoadworkEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set AUTOBAHNAPIDE_TEST_ROADWORK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def roadwork_basic_setup(extra)
  ...
  entid_env_raw = ENV["AUTOBAHNAPIDE_TEST_ROADWORK_ENTID"]
