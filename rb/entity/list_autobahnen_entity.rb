...
class ListAutobahnenEntity
  ...
  def make
    opts = @_entopts.dup
    ListAutobahnenEntity.new(@_client, opts)
  end
  ...
  # @return [ListAutobahnen, Hash] the current ListAutobahnen data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ListAutobahnen fields)
  def match_get
  ...
  #
  # @param reqmatch [ListAutobahnenListMatch, Hash, nil] match filter (any subset of
  #   ListAutobahnen fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ListAutobahnen>, Array] the matching ListAutobahnen items; raises AutobahnApiDeError on failure
