...
class ParkingLorryEntity
  ...
  def make
    opts = @_entopts.dup
    ParkingLorryEntity.new(@_client, opts)
  end
  ...
  # @return [ParkingLorry, Hash] the current ParkingLorry data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ParkingLorry fields)
  def match_get
  ...
  #
  # @param reqmatch [ParkingLorryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ParkingLorry.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ParkingLorry, Hash] the loaded ParkingLorry; raises AutobahnApiDeError on failure
  ...
  #
  # @param reqmatch [ParkingLorryListMatch, Hash, nil] match filter (any subset of
  #   ParkingLorry fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ParkingLorry>, Array] the matching ParkingLorry items; raises AutobahnApiDeError on failure
