...
class WebcamEntity
  ...
  #   as an empty match, so client.Webcam.load works with no args).
  ...
  #
  # @param reqmatch [WebcamListMatch, Hash, nil] match filter (any subset of
  #   Webcam fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
